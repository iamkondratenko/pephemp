...
/* /Users/alexkondratenko/gitlab/pep-hemp/themes/demo/partials/blog/blog.htm */
class __TwigTemplate_57bf6c8b6c6c887d6cdd57c5a2b358d032bcccab74cc73b0c20d5f8ea74b36fc extends \Twig\Template
{
    private $source;
    private $macros = [];
            ...
            <div class=\"blog__items\">
                <div class=\"blog__item\">
                    <div class=\"blog__item__img-holder\">
                        <a href=\"#\"><img class=\"blog__item__img\" src=\"./assets/blog/oil.png?1\" alt=\"\"></a>
                    </div>
                    <h4 class=\"blog__item__title\">Олія конопляна догляд за руками і нігтями</h4>
                    <p class=\"blog__item__description\">
                        Конопляна олія від природи збагачена величезною кількістю вітамінів та мікроелементів. Їх вплив на шкіру важко переоцінити!
                    </p>
                    <a href=\"#\" class=\"blog__item__link\">Читати далi&nbsp;&nbsp;<span>
                ...
                <div class=\"blog__item\">
                    <div class=\"blog__item__img-holder\">
                        <a href=\"#\"><img class=\"blog__item__img\" src=\"./assets/blog/milo.png?1\" alt=\"\"></a>
                    </div>
                    <h4 class=\"blog__item__title\">Властивостi конопляного мила</h4>
                    <p class=\"blog__item__description\">
                        Конопляна олія від природи збагачена величезною кількістю вітамінів та мікроелементів. Їх вплив на шкіру важко переоцінити!
                    </p>
                    <a href=\"#\" class=\"blog__item__link\">Читати далi&nbsp;&nbsp;<span>
                ...
                <div class=\"blog__item\">
                    <div class=\"blog__item__img-holder\">
                        <a href=\"#\"><img class=\"blog__item__img\" src=\"./assets/blog/seeds.png?1\" alt=\"\"></a>
                    </div>
                    <h4 class=\"blog__item__title\">Нове знайомство зі старим другом!</h4>
                    <p class=\"blog__item__description\">
                        Конопляна олія від природи збагачена величезною кількістю вітамінів та мікроелементів. Їх вплив на шкіру важко переоцінити!
                    </p>
                    <a href=\"#\" class=\"blog__item__link\">Читати далi&nbsp;&nbsp;<span>
    ...
    {
        return "/Users/alexkondratenko/gitlab/pep-hemp/themes/demo/partials/blog/blog.htm";
    }
    ...
    public function getSourceContext()
    {
        ...
        </div>", "/Users/alexkondratenko/gitlab/pep-hemp/themes/demo/partials/blog/blog.htm", "");
    }
}

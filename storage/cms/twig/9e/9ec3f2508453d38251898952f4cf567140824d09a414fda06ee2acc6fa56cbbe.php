...
<html>
    <head>
        ...
        <link href=\"";
        // line 14
        echo $this->extensions['Cms\Twig\Extension']->themeFilter("assets/css/style.css?fgg23ffffhgff4df");
        echo "\" rel=\"stylesheet\">
        ";
        // line 15
    ...
    <body>
        ...
        <script src=\"";
        // line 31
        echo $this->extensions['Cms\Twig\Extension']->themeFilter("assets/javascript/app.js?2ff3fcf");
        echo "\"></script>
        ";
        // line 32
...
<html>
    <head>
        ...
        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">
        <meta name=\"generator\" content=\"OctoberCMS\">
        <link href=\"{{ 'assets/css/style.css?fgg23ffffhgff4df'|theme }}\" rel=\"stylesheet\">
        {% styles %}
    ...
    <body>
        ...
        <!-- Scripts -->
        <script src=\"{{ 'assets/javascript/app.js?2ff3fcf'|theme }}\"></script>
        {% scripts %}
